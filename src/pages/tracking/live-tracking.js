...
const MainComponent = () => {
  ...
  const tripStatus = [{ key: "All", value: "All" }, { key: "Not Ended", value: "In progress" }, { key: "Completed", value: "Completed" }];
        ...
        !mapShow ?
          <div>
                ...
                <FormControl fullWidth>
                  ...
                  >
                    {tripStatus.map((item, idx) => (
                      <MenuItem key={idx} value={item.key}>{item.value}</MenuItem>
                    ))}
                  </Select>
                </FormControl>
              </div>
            ...
            >
              ...
              <LiveTrackingTable tripData={tripData} />
            </div>
          </div>
          :
          <div style={{ margin: "40px" }}>
            <div className="d-flex" style={{ width: '100%' }}>
              <div className="d-flex" style={{ width: '100%', justifyContent: 'flex-end', marginBottom: 20 }}>
                <button
                  className="btn btn-primary"
                  style={{
                    width: "auto",
            ...
            <LiveTrackingMap officeId={searchValues.officeId} fullMapShow={fullMapShow}/>
          </div>}
    </div>
  );
};
