...
import Messaging from "@/components/configurations/communication/messaging";
import TransportDetails from "@/components/configurations/communication/transportDetails";

const Communication = () => {
  const [currentState, setCurrentState] = useState("Messaging");
  ...
  return (
    <div className="mainSettingsContainer">
      ...
      <div style={{ padding: "20px 0" }}>
        ...
        <div>
          {currentState === "Messaging" && <Messaging />}
          {currentState === "Transport Details" && <TransportDetails />}
        </div>
      </div>
    </div>
  );
...
export default Configurations(Communication);
