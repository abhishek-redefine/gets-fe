...
const LiveTrackingMap = ({ officeId, fullMapShow }) => {
    ...
    return (
        <div className="d-flex">
            ...
            <div style={{ height: '90vh', width: !fullMapShow ? '64%' : '100%', marginLeft: '1%', borderRadius: 40 }}>
                <MapContainer center={[28.58, 77.30]} zoom={15} style={{ height: "90vh", width: "100%", borderRadius: 40 }}>
                    <TileLayer
                    ...
                    />
                    {
                        ...
                        cabsList.map((item, index) => {
                            return (
                                <Marker key={index} position={[item.latitude, item.longitude]} icon={createRotatedIcon(item.heading)}>
                                    <Popup>
                                        <div>
                                            ...
                                            <p>Trip State : {item.trip_ended ? "Completed" : "Ongoing"}</p>
                    ...
                    }
                    {
                        ...
                        officeList.map((val,index)=>{
                            ...
                            return(
                                <Marker key={index} position={[lat, long]} icon={createOfficeIcon()}>
                                    <Popup>
                                        <div>
