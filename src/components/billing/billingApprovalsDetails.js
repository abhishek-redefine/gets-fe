...
const BillingApprovalsDetails = ({ onClose, tripId, tripdetails, officeId, date, IssueType }) => {
              ...
              <div class="">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Label id="shiftType-label">Issue Type *</Label>
                      <p>{IssueType}</p>
                    </FormControl>
                    {/* <Box
                      component="form"
...
export default BillingApprovalsDetails;
