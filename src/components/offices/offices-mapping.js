                ...
                <div className='btnContainerWithLeftContent'>
                    <div className={styles.roleSelectionContainer}>
                        ...
                        <FormControl fullWidth>
                            ...
                            >
                                {officeListing.map((office, oIdx) => (
                                    !!office?.officeId && <MenuItem key={oIdx} value={office?.officeId}>{office?.officeId}, {office?.address}, {office?.city}</MenuItem>
                                ))}
                            </Select>
                        </FormControl>
                        </div>}
                        <div>
                        <button onClick={viewOffice} disabled={!selectedOfficeId} className='btn btn-primary'>View Office</button>
                        </div>
                    </div>
                    <div>
                        <button onClick={() => setIsAddEdit(true)} className='btn btn-primary'>Add Office Mapping</button>
                    </div>
                </div>
