...
const validationSchemaStepEight = object({
  driverTrainingCertUrl: string().required(
    "Driver Training Certificate is required"
  ),
});
...
const AddNewDriver = ({ EditDriverData, SetAddDriverOpen }) => {
  ...
  const [driverId, setDriverId] = useState(
    EditDriverData ? EditDriverData.id : null
  );
  ...
  const addNewDriverDetailsSubmit = async (values) => {
    ...
    try {
      ...
      if (EditDriverData?.id) {
        ...
        //     return;
        // }
        const response = await ComplianceService.updateDriver({
          driver: values,
        });
        if (response.status === 200) {
          ...
          dispatch(
            toggleToast({
              message:
                "Driver details not updated. Please try again after some time.",
              type: "error",
            })
          );
          return false;
        ...
        values.vendorName = vendorName;
        const response = await ComplianceService.createDriver({
          driver: values,
        });
        if (response.status === 200) {
          setDriverId(response.data.driver.id);
          ...
          dispatch(
            toggleToast({
              message:
                "Driver details not added. Please try again after some time.",
              type: "error",
            })
          );
          return false;
      ...
      if (response.status === 200) {
        ...
        if (documentToUpload === "/LICENSE_CERTIFICATE") {
          ...
          EditDriverData.policeVerificationUrl =
            response.data.driver.policeVerificationUrl;
          ...
          EditDriverData.driverTrainingCertUrl =
            response.data.driver.driverTrainingCertUrl;
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center" }}>
            <TextInputField name="name" label="Driver Name" />
            <TextInputField name="mobile" label="Driver Mobile No" />
            <DateInputField name="dob" label="DOB" maxDate={dayjs()} />
            <SelectInputField
              name="gender"
              label="Gender"
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <TextInputField name="licenseNo" label="License No" />
            <DateInputField
              name="licenseExpiry"
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            <TextInputField name="altMobile" label="Alternate Mobile Number" />
            <TextInputField name="address" label="Address" />
            <TextInputField name="aadharId" label="Aadhar ID" />
            <TextInputField name="panNo" label="Pan No" />
          </div>
          <div style={{ display: "flex", alignItems: "center" }}>
            <TextInputField name="email" label="Email" />
            <TextInputField name="remarks" label="Remarks" />
            <DateInputField
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            <DateInputField name="bgvDate" label="BGV Date" maxDate={dayjs()} />
            <DateInputField
              name="ddTrainingDate"
                  ...
                  {EditDriverData?.licenseUrl &&
                    EditDriverData.licenseUrl !== "" && (
                      <button
                        ...
                        onClick={() => {
                          setDocumentUrl(
                            EditDriverData.licenseUrl.replace("/getsdev1/", "/")
                          );
                          handleOpen();
                        }}
                        style={{
                  ...
                  {EditDriverData?.undertakingUrl &&
                    EditDriverData.undertakingUrl !== "" && (
                      <button
                        ...
                        onClick={() => {
                          setDocumentUrl(
                            EditDriverData?.undertakingUrl.replace(
                              "/getsdev1/",
                              "/"
                            )
                          );
                ...
                >
                  ...
                  {EditDriverData?.bgvUrl && EditDriverData.bgvUrl !== "" && (
                    <button
                      ...
                      onClick={() => {
                        setDocumentUrl(
                          EditDriverData?.bgvUrl.replace("/getsdev1/", "/")
                        );
                        handleOpen();
                      }}
                      style={{
                  ...
                  {EditDriverData?.policeVerificationUrl &&
                    EditDriverData.policeVerificationUrl !== "" && (
                      <button
                        ...
                        onClick={() => {
                          setDocumentUrl(
                            EditDriverData?.policeVerificationUrl.replace(
                              "/getsdev1/",
                              "/"
                            )
                          );
                  ...
                  {EditDriverData?.photoUrl &&
                    EditDriverData.photoUrl !== "" && (
                      <button
                        ...
                        onClick={() => {
                          setDocumentUrl(
                            EditDriverData?.photoUrl.replace("/getsdev1/", "/")
                          );
                          handleOpen();
                        }}
                        style={{
                  ...
                  {EditDriverData?.badgeUrl &&
                    EditDriverData.badgeUrl !== "" && (
                      <button
                        ...
                        onClick={() => {
                          setDocumentUrl(
                            EditDriverData?.badgeUrl.replace("/getsdev1/", "/")
                          );
                          handleOpen();
                        }}
                        style={{
                  ...
                  {EditDriverData?.driverTrainingCertUrl &&
                    EditDriverData.driverTrainingCertUrl !== "" && (
                      <button
                        ...
                        onClick={() => {
                          setDocumentUrl(
                            EditDriverData?.driverTrainingCertUrl.replace(
                              "/getsdev1/",
                              "/"
                            )
                          );
                  ...
                  {EditDriverData?.medicalCertUrl &&
                    EditDriverData.medicalCertUrl !== "" && (
                      <button
                        ...
                        onClick={() => {
                          setDocumentUrl(
                            EditDriverData?.medicalCertUrl.replace(
                              "/getsdev1/",
                              "/"
                            )
                          );
