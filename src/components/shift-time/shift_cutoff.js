  ...
  return (
    <div>
      <div className="internalSettingContainer">
        {!cutOffState.forEdit &&
          !cutOffState.forCancel &&
          !cutOffState.forNoShow && (
            <div>
              <div style={{ display: "flex", justifyContent: "end" }}>
                <div className="btnContainer">
                  <button
                    onClick={() =>
                      setCutOffState({ ...cutOffState, forEdit: true })
                    }
                ...
                >
                  <button
                    onClick={() =>
                      setCutOffState({ ...cutOffState, forCancel: true })
                    }
                    className="btn btn-primary"
                  >
                    Cutoff for cancel
                ...
                <div className="btnContainer">
                  <button
                    onClick={() =>
                      setCutOffState({ ...cutOffState, forNoShow: true })
                    }
                    className="btn btn-primary"
                  >
                    Cutoff for no show
